...
class Model{
    ...
    public function query(string $query,array $params = null, bool $update = null){
        ...
        if($statementType == "UPDATE" OR $statementType == "INSERT"){
            return $exec;
        }elseif (!$params){
    ...
    protected function fetchById(string $table, int $id){
